...
$fn = new admin\controllers\a_socials;
if ($fn->is_ajax_call()) {
                ...
                <div class="row">
                    <div class="form-group col-sm-6">
                        ...
                        <input type="text" name="title" id="title" class="form-control"
                               value="<?php echo $fn->post('title'); ?>" autofocus required/>
                    </div>
                    <div class="form-group col-sm-6">
                        <label for="class" class="input-label req"><?php echo _('Class'); ?></label>
                        <input type="text" name="class" id="class" class="form-control"
                               value="<?php echo $fn->post('class'); ?>" required/>
                    </div>
                    <div class="clearfix"></div>
                    <div class="form-group col-sm-9">
                        <label for="url" class="input-label req"><?php echo _('Url'); ?></label>
                        <input type="url" name="url" id="url" class="form-control"
                               value="<?php echo $fn->post('url'); ?>" placeholder="e.g. https://www.facebook.com"
                               required/>
                    </div>
