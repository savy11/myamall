...
(function (e, t) {
    ...
    function L(n, r) {
        ...
        if (l == 12 || l == 13 || l == 14 || l == 15) {
            ...
            var j = 0;
            var F = 0;
            if (l == 12) j = D; else if (l == 15) j = 0 - D; else if (l == 13) F = P; else if (l == 14) F = 0 - P;
            var I = 1;
            var q = 1;
            var R = 1;
            ...
            if (d == 6) R = .6;
            TweenLite.fromTo(H, W, {left: j, top: F, scale: R, opacity: I, rotation: r.rotate}, {
                opacity: 1,
                rotation: 0,
                left: 0,
                top: 0,
    ...
    function X(n, r, i) {
        ...
        n.find(".tp-caption").each(function (n) {
            ...
            if (l == 0) {
                        ...
                        if (n.attr("src").toLowerCase().indexOf("youtube") >= 0) {
                                    ...
                                    var o = setInterval(function () {
                                        if (YT != t) if (typeof YT.Player != t && typeof YT.Player != "undefined") {
                                            if (f.data("autoplay") == true) {
                                                s = new YT.Player(c, {
                                                    events: {
                                                        onStateChange: j, onReady: function (e) {
                                                            e.target.playVideo()
                                                        }
                                                    }
                                                })
                                            } else s = new YT.Player(c, {events: {onStateChange: j}});
                            ...
                            if (n.attr("src").toLowerCase().indexOf("vimeo") >= 0) {
                                if (!n.hasClass("HasListener")) {
                                    ...
                                    if (l["player_id"] != t) a = a.replace(l["player_id"], c); else a = a + "&player_id=" + c;
                                    try {
                                    ...
                                    if (f.data("autoplay") == true) {
                                        ...
                                        var m = $f(v);
                                        f.data("timerplay", setTimeout(function () {
                                            if (f.data("forcerewind") == "on") m.api("seekTo", 0);
                                            m.api("play")
                                        }, f.data("start")))
                                    }
                                }
                ...
                if (f.data("x") == "center" || f.data("xcenter") == "center") var M = f.data("x") + s; else var M = u * f.data("x") + s;
                if (f.data("y") == "center" || f.data("ycenter") == "center") var _ = f.data("y") + o; else var _ = r.bh * f.data("y") + o;
                ...
                if (!i) {
                    ...
                    if (f.hasClass("customin")) F = z(F, f.data("customin")); else if (f.hasClass("randomrotate")) {
    ...
    function Z(n, r) {
        ...
        if (r.slideamount > 1 && !(r.stopAfterLoops == 0 && r.stopAtSlide == 1)) {
            ...
            r.cdint = setInterval(function () {
                ...
                TweenLite.to(i, .3, {width: r.cd / r.delay * 100 + "%"});
